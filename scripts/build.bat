@echo off
REM ============================================================
REM BMC Auto-Capture v0.2.5-RC3 - Build Script
...
echo.
echo ============================================================
echo   BMC Auto-Capture v0.2.5-RC3 - Build
echo ============================================================
echo.
...
echo.
echo BMC Auto-Capture v0.2.5-RC3
echo ========================
echo.
...
echo   7z a bmc-auto-capture-v0.2.5-RC3.7z "%DIST%"
echo.

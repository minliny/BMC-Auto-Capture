@echo off
REM ============================================================
REM BMC Auto-Capture v0.2.5-RC2 - Build Script
...
echo.
echo ============================================================
echo   BMC Auto-Capture v0.2.5-RC2 - Build
echo ============================================================
echo.
...
echo.
echo BMC Auto-Capture v0.2.5-RC2
echo ========================
echo.
...
echo   7z a bmc-auto-capture-v0.2.5-RC2.7z "%DIST%"
echo.
